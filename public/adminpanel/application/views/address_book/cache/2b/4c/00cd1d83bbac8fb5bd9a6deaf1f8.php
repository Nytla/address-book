...
/* edit_client.html */
class __TwigTemplate_2b4c00cd1d83bbac8fb5bd9a6deaf1f8 extends Twig_Template
{
...
\t\t\t\t\t\t</form>
\t\t\t\t\t</div>
\t\t\t\t\t<div id=\"edit_good_message\" class=\"hide\">";
        // line 82
        echo twig_escape_filter($this->env, $this->getContext($context, 'edit_good_message'), "html");
        echo "</div>
\t\t\t\t\t<div id=\"edit_bad_message\" class=\"hide\">";
        // line 83
        echo twig_escape_filter($this->env, $this->getContext($context, 'edit_bad_message'), "html");
        echo "</div>
\t\t\t\t</fieldset>
\t\t\t</div>
\t\t\t<br>

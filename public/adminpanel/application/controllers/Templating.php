...
class Templating extends Exceptions {
	 ...
	 */
	public function renderingTemplate($template_name, $params) {
		...
		**/
		$this -> _path_to_template = Config::dataArray('templates', 'path').Config::dataArray('templates', 'name');

		$loader = new Twig_Loader_Filesystem($this -> _path_to_template);

		/**
		 * Templates cache
		**/
		$this -> _path_to_cache = Config::dataArray('templates', 'path').Config::dataArray('templates', 'name').Config::dataArray('templates', 'cache');
